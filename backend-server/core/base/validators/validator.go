...
func NewValidator() *validator.Validate {
	...
	validatorInstance.RegisterCustomTypeFunc(ValidateValuer, customtypes.NullString{}, customtypes.NullInt64{}, customtypes.NullBool{}, customtypes.NullBool{}, customtypes.NullTime{}, customtypes.NullStatusEnum{})
...
func GetAllErrors(err error, anyType interface{}) []*dto.IError {
	t := reflect.TypeOf(anyType)

	// Check if it's a pointer, and get the underlying element if it is
